...
public class HotkeyTester extends JFrame implements HotkeyListener, IntellitypeListener {

	   /**
	    * Logger for this class
	    */
	   private static final Log LOG = LogFactory.getLog(HotkeyTester.class);
	   private static HotkeyTester mainFrame;
	   ...
	   public static void main(String[] args) {
	      ...
	      if (!JIntellitype.isJIntellitypeSupported()) {
	         LOG.error("JIntellitype.DLL is not found in the path or this is not Windows 32bit OS.");
	         System.exit(1);
	      }

	      mainFrame = new HotkeyTester();
